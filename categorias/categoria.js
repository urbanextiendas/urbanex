...
function urbanexTimeBackground() {
    ...
    const band = hour >= 7 && hour < 13 ? 'dia' : hour >= 13 && hour < 19 ? 'tarde' : 'noche';
    const mobile = window.matchMedia('(max-width: 720px)').matches;
    const images = mobile
        ? { dia: '../imagenes/boulevard/Boul_mañana-Celular.png', tarde: '../imagenes/boulevard/Boul_tarde-Celular.png', noche: '../imagenes/boulevard/Boul_noche-Celular.png' }
        : { dia: '../imagenes/boulevard/Boul_mañana.png', tarde: '../imagenes/boulevard/Boul_tarde.png', noche: '../imagenes/boulevard/Boul_noche.png' };
    return images[band];
}
