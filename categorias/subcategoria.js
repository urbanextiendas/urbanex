...
function cardHtml(business) {
    ...
    const coverHtml = cover
        ? `<img class="ux-card-cover"
                src="${esc(cover)}"
                alt="${esc(business.name || 'Negocio')}"
                loading="lazy">`
        : `<div class="ux-card-cover-placeholder">${icon}</div>`;
    const featured = isFeatured(business)
        ? '<span class="ux-card-featured">Destacado</span>'
        : '';
    ...
    return `
        <a class="ux-card" href="${esc(businessLink(business))}"
           aria-label="Ver negocio ${esc(business.name || 'Urbanex')}">
            <div class="ux-card-media">
                ${coverHtml}
                ${featured}
                <div class="ux-card-logo">${logoHtml}</div>
            </div>
            <div class="ux-card-body">
                ...
                <div class="ux-card-bottom">
                    ...
                    <span class="ux-card-cta">Ver negocio →</span>
                </div>
            </div>
        </a>
    `;
