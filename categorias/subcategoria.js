...
function rootBackground() {
    ...
    const mediaCelular = window.matchMedia('(max-width: 720px)');
    ...
    const type = mediaCelular.matches ? 'celular' : 'desktop';
...
const urbanexSubcategoryMedia = window.matchMedia('(max-width: 720px)');
...
if (urbanexSubcategoryMedia.addEventListener) urbanexSubcategoryMedia.addEventListener('change', updateUrbanexSubcategoryBackground);
else if (urbanexSubcategoryMedia.addListener) urbanexSubcategoryMedia.addListener(updateUrbanexSubcategoryBackground);
