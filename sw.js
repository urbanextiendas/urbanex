...
const CACHE_NAME    = 'urbanex-v13';
const CACHE_STATIC  = 'urbanex-static-v13';
...
self.addEventListener('fetch', event => {
    ...
    if (
        ...
        (url.pathname === '/registro.html' || (url.pathname === '/registro-v12.html' || url.pathname === '/registro-v13.html'))
    ) {
